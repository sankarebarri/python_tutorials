...
# if re.search(r"^\w+@\w+\.(edu|gov|com|info)$", re_email.lower()): # \w represents [a-zA-Z0-9_]
if re.search(r"^(\w|\.)+@(\w+\.)?\w+\.(edu|gov|com|info)$", re_email, re.IGNORECASE): # \w represents [a-zA-Z0-9_]
    print("Email Valid")
else:
    print("Email Invalid")
