...
multi_parser = subparsers.add_parser(
    "multi", help="multiply two numbers, a and b")
multi_parser.add_argument(**arg_template)
multi_parser.set_defaults(func=mul)

div_parser = subparsers.add_parser(
    "division", help="divide two numbers, a and b")
